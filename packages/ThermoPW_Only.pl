...
my $package = "q-e";
my $currentVer = "qe-6.7.tar.gz";#***** the latest version of this package (check the latest one if possible)
my $unzipFolder = "q-e-qe-6.7";#***** the unzipped folder of this package (check the latest one if possible)
