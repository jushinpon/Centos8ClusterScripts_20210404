...
PairMM3Switch3::PairMM3Switch3(LAMMPS *lmp) : Pair(lmp)
{
...
void PairMM3Switch3::compute(int eflag, int vflag)
{
...
void PairMM3Switch3::settings(int narg, char **arg)
{
...
void PairMM3Switch3::coeff(int narg, char **arg)
{
  if (narg < 5 || narg > 6)
...
void PairMM3Switch3::init_style()
{
  //if (!atom->q_flag)
...
double PairMM3Switch3::init_one(int i, int j)
{
  if (setflag[i][j] == 0) {
...
void PairMM3Switch3::write_restart(FILE *fp)
{
...
void PairMM3Switch3::read_restart(FILE *fp)
{
...
void PairMM3Switch3::write_restart_settings(FILE *fp)
{
...
void PairMM3Switch3::write_data(FILE *fp)
{
...
void PairMM3Switch3::write_data_all(FILE *fp)
{
  for (int i = 1; i <= atom->ntypes; i++)
...
double PairMM3Switch3::single(int i, int j, int itype, int jtype,
                                 double rsq,
...
void *PairMM3Switch3::extract(const char *str, int &dim)
{
  dim = 0;
